    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-purple-800 to-indigo-900 text-white">
      ...
      <nav className="flex items-center justify-between px-6 py-4">
        <div className="flex items-center space-x-2">
          ...
          <span className="text-xl font-bold">{t('pageNotFoundTitle')}</span>
        </div>
      ...
      <div className="flex flex-col items-center justify-center px-6 py-20 text-center">
        ...
        <div className="inline-flex items-center px-4 py-2 bg-purple-800/50 backdrop-blur-sm rounded-full border border-purple-600/30 mb-8">
          <span className="text-purple-300 text-sm font-medium">{t('oops')}</span>
        </div>

        {/* Main Heading */}
        <h1 className="text-6xl md:text-7xl lg:text-8xl font-bold mb-6 leading-tight">
          <span className="text-white">{t('pageNot')}</span>
          <br />
